...
class Game {
  ...
  placeInTable(y, x) {
    ...
    piece.style.backgroundImage = `url(${this.currPlayer.color}.jpg)`;
    piece.style.backgroundSize = 'contain';
    piece.style.imageRendering = '-webkit-optimize-contrast';
    piece.style.border = '1px solid black';
    piece.style.backgroundColor = '#BD3944';
...
function createGame(){
  playerOne = new Player(document.querySelector('#player1').value);
  playerTwo = new Player(document.querySelector('#player2').value);
  removeAllChildNodes(document.querySelector('#board'));
  myGame = new Game(7, 7);
  myGame.makeBoard();
